...
public function login_in_process(){
    ...
    {      
        ...
        //lead
        $enq_count = $data['leadCount']=$this->dashboard_model->countLead(2);
        $enq_Sum = $data['leadSum']=$this->dashboard_model->dataLead(2);
      //  echo 'Count:'.$enq_count.'<br>value:';print_r($enq_Sum->result());
      // exit();
        //client
        $data['clientCount2']=$this->dashboard_model->countLead(3);
        $leadSum = $data['clientsum']=$this->dashboard_model->dataLead(3);
