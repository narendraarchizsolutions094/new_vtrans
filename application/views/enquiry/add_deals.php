...
return;	
	...
	{
		Swal.fire({
			title:'You are authorized to give discount upto '+max_discount+'% only. So Please save deal and if you provide more discount then edit deal and send this quotation to your reporting manager for further approval.',
			icon:'warning',
			type:'warning',
			showConfirmButton:false,
		});
