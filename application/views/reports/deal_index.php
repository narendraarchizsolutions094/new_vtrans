...
<script src="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/js/select2.min.js"></script>  
      <div  class="panel panel-default thumbnail">
         <div class="panel-heading no-print">
            <div class="btn-group"> 
               <a class="btn btn-success" href="<?php echo base_url("report/deal_report_panel") ?>"> <i class="fa fa-plus"></i>  <?php echo display('report_filter_create') ?> </a>  
            </div>
         </div>
                  ...
                  if (!empty($reports)) {
                     ...
                     foreach ($reports as $key => $value) { ?>
                        <tr>
                           ...
                           <td>
                              <a href="<?=base_url().'report/deal_view/'.$value['id'].'/'.base64_encode($value['name'])?>" class='btn btn-warning'>View</a>
                <?php  if(user_access(124)){ ?>
