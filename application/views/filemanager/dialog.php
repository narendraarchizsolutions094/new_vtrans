...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?=base_url().'assets/filemanager/css/jquery.fileupload.css'?>">
        <link rel="stylesheet" href="<?=base_url().'assets/filemanager/css/jquery.fileupload-ui.css'?>">
        <!-- CSS adjustments for browsers with JavaScript disabled -->
        <noscript><link rel="stylesheet" href="<?=base_url().'assets/filemanager/css/jquery.fileupload-noscript.css'?>"></noscript>
        <noscript><link rel="stylesheet" href="<?=base_url().'assets/filemanager/css/jquery.fileupload-ui-noscript.css'?>"></noscript>
        ...
        <link href="<?=base_url().'assets/filemanager/css/style.css?v='.$version; ?>" rel="stylesheet" type="text/css" />
        <!--[if lt IE 8]>
        <style>
        ...
        <script src="<?=base_url().'assets/filemanager/js/plugins.js?v='.$version; ?>"></script>
        ...
        <script src="<?=base_url().'assets/filemanager/js/modernizr.custom.js'?>"></script>
        ...
        <script src="<?=base_url().'assets/filemanager/js/include.js?v='.$version; ?>"></script>
</head>
<body>
    ...
    <script src="<?=base_url().'assets/filemanager/js/jquery.iframe-transport.js'?>"></script>
    <!-- The basic File Upload plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload.js'?>"></script>
    <!-- The File Upload processing plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload-process.js'?>"></script>
    <!-- The File Upload image preview & resize plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload-image.js'?>"></script>
    <!-- The File Upload audio preview plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload-audio.js'?>"></script>
    <!-- The File Upload video preview plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload-video.js'?>"></script>
    <!-- The File Upload validation plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload-validate.js'?>"></script>
    <!-- The File Upload user interface plugin -->
    <script src="<?=base_url().'assets/filemanager/js/jquery.fileupload-ui.js'?>"></script>
            ...
            foreach ($files as $nu=>$file_array) {
                ...
                if(in_array($file_array['extension'], $config['ext_img'])){
                    ...
                    if($ftp){
                        ...
                        $creation_thumb_path = $mini_src = $src_thumb = base_url().$thumbs_path. $file;
                ...
                if($src_thumb==""){
                    ...
                    if(file_exists('img/'.$config['icon_theme'].'/'.$file_array['extension'].".jpg")){
                        $src_thumb = base_url().'assets/filemanager/img/'.$config['icon_theme'].'/'.$file_array['extension'].".jpg";
                    }else{
                        $src_thumb = base_url()."assets/filemanager/img/".$config['icon_theme']."/default.jpg";
                    }
                    $is_icon_thumb=true;
                }
                if($mini_src==""){
...
?>
            ...
            <?php if($config['multiple_selection']){ ?><div class="selector">
                ...
                <figcaption>
                    ...
                    <a class="tip-right preview" title="<?php echo trans('Preview')?>" data-featherlight="<?php echo base_url().$src;?>"  href="#"><i class=" icon-eye-open"></i></a>
                    ...
                    title="<?php echo trans('Preview')?>" data-url="<?=base_url().'filemanager/filemanager/ajax_calls?action=media_preview&title='.$filename.'&file='.$rfm_subfolder.$subdir.$file;?>"
                    href="javascript:void('');" ><i class=" icon-eye-open"></i></a>
                    <?php }elseif(in_array($file_array['extension'],$config['cad_exts'])){ ?>
                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview')?>" data-url="<?=base_url()?>filemanager/filemanager/ajax_calls?action=cad_preview&title=<?php echo $filename;?>&file=<?php echo $rfm_subfolder.$subdir.$file;?>"
                    href="javascript:void('');" ><i class=" icon-eye-open"></i></a>
                    <?php }elseif($config['preview_text_files'] && in_array($file_array['extension'],$config['previewable_text_file_exts'])){ ?>
                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview')?>" data-url="<?=base_url()?>filemanager/filemanager/ajax_calls?action=get_file&sub_action=preview&preview_mode=text&title=<?php echo $filename;?>&file=<?php echo $rfm_subfolder.$subdir.$file;?>"
                    href="javascript:void('');" ><i class=" icon-eye-open"></i></a>
                    <?php }elseif($config['googledoc_enabled'] && in_array($file_array['extension'],$config['googledoc_file_exts'])){ ?>
                    <a class="tip-right file-preview-btn" title="<?php echo trans('Preview')?>" data-url="<?=base_url()?>filemanager/filemanager/ajax_calls?action=get_file&sub_action=preview&preview_mode=google&title=<?php echo $filename;?>&file=<?php echo $rfm_subfolder.$subdir.$file;?>"
...
<script>
    ...
    <div id="loading_container" style="display:none;">
        ...
        <img id="loading_animation" src="<?=base_url()?>assets/filemanager/img/storing_animation.gif" alt="loading" style="z-index:10001; margin-left:-32px; margin-top:-32px; position:fixed; left:50%; top:50%">
    </div>
    <!-- loading div end -->
    ...
    <?php if ( $config['tui_active'] ) { ?>
        ...
        if (image_editor) { 
            ...
            function saveTUI()
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?=base_url().'filemanager/Filemanager/'?>ajax_calls?action=save_img",
