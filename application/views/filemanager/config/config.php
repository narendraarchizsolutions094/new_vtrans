...
$config = array(
    ...
    */
    ...
    |
    */
    'current_path' => 'uploads/filemanager/',
    ...
    |
    */
    'thumbs_base_path' => 'uploads/filemanager_thumbs/',
    ...
    *******************/
    ...
    // main icons
    'menu.normalIcon.path'                 => base_url().'assets/filemanager/svg/icon-d.svg',
    'menu.normalIcon.name'                 => 'icon-d',
    'menu.activeIcon.path'                 => base_url().'assets/filemanager/svg/icon-b.svg',
    'menu.activeIcon.name'                 => 'icon-b',
    'menu.disabledIcon.path'               => base_url().'assets/filemanager/svg/icon-a.svg',
    'menu.disabledIcon.name'               => 'icon-a',
    'menu.hoverIcon.path'                  => base_url().'assets/filemanager/svg/icon-c.svg',
    ...
    // submenu icons
    'submenu.normalIcon.path'              => base_url().'assets/filemanager/svg/icon-d.svg',
    'submenu.normalIcon.name'              => 'icon-d',
    'submenu.activeIcon.path'              => base_url().'assets/filemanager/svg/icon-b.svg',
