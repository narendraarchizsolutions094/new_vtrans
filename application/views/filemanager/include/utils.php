...
if ( ! function_exists('trans'))
{
	...
	*/
	...
	{
		global $lang_vars;
		$lang_vars = include FCPATH.'application/views/filemanager/lang/en_EN.php';//include '../lang/' . $lang . '.php';
	...
	if(file_exists('lang/' . $lang . '.php')){
		...
		$lang_vars = include FCPATH.'application/views/filemanager/lang/'.$lang.'.php';//include '../lang/' . $lang . '.php';
...
* @return  bool
*/
function __is_really_writable($dir)
{
	$dir = rtrim($dir, '/');
	// linux, safe off
