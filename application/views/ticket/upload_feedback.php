<div class="row">
    <div class="panel panel-default pt-2">
        <div class="panel-heading no-print"
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="<?=base_url('ticket/ftlfeedback')?>" class="btn btn-success"> <i class="fa fa-list"></i> FTL Feedback
                        List
                    </a>
                </div>
            </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 panel-default panel-body" style="border:1px solid #f7f7f7">
                <?php echo form_open_multipart(base_url("ticket/upload_feedback_csv"),array('id'=>'ticket-upload-form')); ?>
                    <div class="row">                        
...
<script>
 function allcsv(){
    var pd=0; 	
    window.location.href='<?php echo base_url();?>lead/createcsv/'+pd+'/'+4;
   }
</script>
