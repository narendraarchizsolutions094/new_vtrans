		...
		<div class="panel panel-primary">
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<input type="text" name="hamali" class="form-control">
				</div>
				<div class="form-group">
					<label>FOV Charges (owner risk)</label>
					<input type="text" name="fovowner" class="form-control">
				</div>

				<div class="form-group">
					<label>FOV Charges (Carrier risk)</label>
					<input type="text" name="fovcarrier" class="form-control">
				</div>
				<div class="form-group">
					<label>AOC Charges</label>
					<input type="text" name="aoc"  class="form-control">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="dcc" class="form-control">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="dccharge" class="form-control">
				</div>
				<div class="form-group">
					<label>Demurrage Charges to be Paid By </label>
					<input type="text" name="dcby" class="form-control">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="dfs" class="form-control">
				</div>
				<div class="form-group">
					<label>E-way bill charge</label>
					<input type="text" name="eway" class="form-control">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="lmdc" class="form-control">
				</div>
				<div class="form-group">
					<label>Re Delivery charges</label>
					<input type="text" name="rdc" class="form-control">
				</div>
			</div>
